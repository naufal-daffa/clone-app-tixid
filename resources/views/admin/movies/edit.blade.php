        ...
        <form action="{{ route('admin.movies.update', $movie['id']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="text" name="genre" id="genre" placeholder="{{ $movie->genre }}" class="form-control
                    @error('genre')
                        is-invalid
                    @enderror"
                        value="{{ $movie['genre'] }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    ...
                    <img src="{{ asset('storage/' . $movie['poster']) }}" alt="" width="200px">
            ...
            <div class="mb-3">
                <label for="description" class="form-label">Sinopsis Film</label>
